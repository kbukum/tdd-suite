...
describe("util/Assertions", () => {
    ...
    it("hasValue", () => {
        expect(Assertions.hasValue(null)).to.be.false;
        expect(Assertions.hasValue(undefined)).to.be.false;
        expect(Assertions.hasValue("")).to.be.true;
        expect(Assertions.hasValue("Danina")).to.be.true;
        expect(Assertions.hasValue(true)).to.be.true;
        expect(Assertions.hasValue(false)).to.be.true;
        expect(Assertions.hasValue(0)).to.be.true;
        expect(Assertions.hasValue(6)).to.be.true;
        expect(Assertions.hasValue(-10)).to.be.true;
        expect(Assertions.hasValue(new Date())).to.be.true;
        expect(Assertions.hasValue([])).to.be.true;
        expect(Assertions.hasValue({})).to.be.true;
    });

    it("hasNotValue", () => {
        expect(Assertions.hasNotValue(null)).to.be.true;
        expect(Assertions.hasNotValue(undefined)).to.be.true;
        expect(Assertions.hasNotValue("")).to.be.false;
        expect(Assertions.hasNotValue("Danina")).to.be.false;
        expect(Assertions.hasNotValue(true)).to.be.false;
        expect(Assertions.hasNotValue(false)).to.be.false;
        expect(Assertions.hasNotValue(0)).to.be.false;
        expect(Assertions.hasNotValue(6)).to.be.false;
        expect(Assertions.hasNotValue(-10)).to.be.false;
        expect(Assertions.hasNotValue(new Date())).to.be.false;
        expect(Assertions.hasNotValue([])).to.be.false;
        expect(Assertions.hasNotValue({})).to.be.false;
    });
