...
describe("util/Types", () => {
    ...
    it("isEmpty", () => {
        expect(Types.isEmpty("")).to.be.true;
        expect(Types.isEmpty(0)).to.be.false;
        expect(Types.isEmpty(1)).to.be.false;
        expect(Types.isEmpty(true)).to.be.false;
        expect(Types.isEmpty(false)).to.be.false;
        expect(Types.isEmpty([])).to.be.true;
        expect(Types.isEmpty(["dsdd"])).to.be.false;
        expect(Types.isEmpty(null)).to.be.true;
        expect(Types.isEmpty(undefined)).to.be.true;
        expect(Types.isEmpty({})).to.be.true;
        expect(Types.isEmpty({ a: ""})).to.be.false;
    });
