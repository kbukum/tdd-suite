...
export default class Assertions {
    ...
    public static hasValue(o: any): boolean {
        return !Assertions.hasNotValue(o);
    }

    public static hasNotValue(o: any): boolean {
        return Assertions.isUndefined(o) || Assertions.isNull(o);
    }
