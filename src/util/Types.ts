...
const UnknownType = new Type<Object>({
    isEmpty: (o: Object) => Type.isEmpty(o),
    isPrimitive: () => false,
    isJsonType: () => false,
    isNativeType: () => false,
...
export default class Types {
    ...
    * finds @see Type by given name of object
    ...
    public static isEmpty(o: any){
        return Types.getType(o).isEmpty(o);
    }
...
Types.Map[Types.ToString.String] = new Type<string>({
    isEmpty: (o: string) => Type.isEmpty(o) || o.trim() === "",
...
Types.Map[Types.ToString.Array] = new Type<any[]>({
    isEmpty: (o: any[]) => Type.isEmpty(o) || o.length === 0,
    isPrimitive: () => false,
